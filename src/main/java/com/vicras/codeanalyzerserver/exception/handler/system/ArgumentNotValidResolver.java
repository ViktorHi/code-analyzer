...
import static com.vicras.codeanalyzerserver.constant.ErrorConstants.FIELD_ERRORS;
import static com.vicras.codeanalyzerserver.constant.ErrorConstants.FIELD_FORMAT_ERROR;
import static com.vicras.codeanalyzerserver.constant.ErrorConstants.GLOBAL_ERRORS;
...
public class ArgumentNotValidResolver {
    ...
    public Map<String, String> addNewErrorMessage(Map<String, List<FieldError>> errors) {
        return errors.entrySet().stream()
                .collect(toMap(Map.Entry::getKey, entry -> getErrorMessageForSameFields(entry.getValue())));
    }
